...
export default function SearchBar({
  ...
  return (
    <div
      className={`flex items-center w-full bg-lure-surface border border-lure-tan rounded-md overflow-hidden transition-all focus-within:border-lure-tan focus-within:ring-1 focus-within:ring-lure-tan/40 ${
